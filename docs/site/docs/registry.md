...
- [Stellar Registry CLI](https://crates.io/crates/stellar-registry-cli), the main interface used to _write_ to Stellar Registry today. This is the tool you use to _publish Wasms_ and _deploy Contracts_ to Stellar Registry, or to register already-uploaded Wasms and already-deployd Contracts. [Source](https://github.com/stellar-registry/cli)
