...
Once [stellar-scaffold/cli#259](https://github.com/stellar-scaffold/cli/issues/259) is complete, you will be able to run `stellar scaffold reset`. Until then, you can remove the alias that Stellar Scaffold uses to keep track of this contract. Stop the `npm run start` process, then run:
